	...
	var k = {
		...
		updateSlides: function () {
			...
			if (
				...
				(h = t),
					Math.floor(e.virtualSize - n) - Math.floor(h[h.length - 1]) >
							...
							? ((e) => {
									if (!e.parentElement)
										return t.slides.filter(
											(t) =>
												t.shadowEl && t.shadowEl === e.parentNode
										)[0];
			...
			function d(e) {
				...
				if (
					...
					if (
						...
						let e = !1;
						if (
							y(t.el, `.${t.params.slideClass}, swiper-slide`).length >
								0 &&
							...
							f() &&
								t.pagination.bullets.forEach((s) => {
									t.params.pagination.clickable &&
										...
										s.matches(
											te(t.params.pagination.bulletActiveClass)
										)
